<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminRestPwd.aspx.cs" Inherits="Admin_AdminRestPwd" %>
    ...
    <form id="form1" runat="server">
        <div class="contact">
            <div class="container1">
                <div class="row">
                    <div class="col-md-12">
                        <h2 style="text-align:center" class="h3New">Forgot Password</h2>
