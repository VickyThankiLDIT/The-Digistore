<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="AdminChangepassword.aspx.cs" Inherits="Admin_AdminChangepassword" %>
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100 mt-5 mb-5">
        <div class="bg-white text-center pb-5 pl-5 pr-5 pt-3 mt-5 center" style="background-color: rgba(0,0,0,0.5)">
            ...
            <form class="pb-3" action="#">
                ...
                <div>
                    <asp:Label ID="lblchgpwd" runat="server"></asp:Label>
                </div>
            </form>
            <asp:Button CssClass="btn bg-danger" Text="Change Password" runat="server" OnClick="Unnamed1_Click" />        </div>
    </div>
</asp:Content>
